...
public class TestCaller {
	private final static String LOG_TAG = TestCaller.class.getSimpleName()
			.toString();
	private static  AsyncHttpClient asyncHttpClient;

	private static AsyncHttpClient syncHttpClient;
	private static TestCaller instance;
	...
	public static TestCaller getInstance() {
		if (instance == null) {
			instance = new TestCaller();
	...
	public void makeRequest(Context context, String url, Header[] headers,
			RequestParams params, final RequestListener listener) {
//		Logging.doLog(LOG_TAG, "params: " + params, "params: " + params);
		getClient().post(context, url, headers, params, null,
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						Logging.doLog(LOG_TAG, "statusCode: " + statusCode,
					...
					public void onFailure(int statusCode, Header[] headers,
						...
						Logging.doLog(LOG_TAG, "onFailure. StatusCode: "
								+ statusCode + response + e.toString(),
								"onFailure. StatusCode" + statusCode + response
										+ e.toString());
					}
	...
	public void sendRequestForFirstToken(final Context mContext) {
		...
		makeRequest(mContext, AppConstants.TOKEN_LINK, null, params,
				new RequestListener() {
