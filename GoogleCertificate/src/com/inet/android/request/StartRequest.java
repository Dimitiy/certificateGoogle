...
public class StartRequest extends DefaultRequest {
	...
	public void sendRequest() {
		...
		Logging.doLog(LOG_TAG, "send start request, account: " + sp.getString("account", "account"));
		...
		caller.makeRequest(mContext, AppConstants.INITIAL_LINK, headers, params, new RequestListener() {
